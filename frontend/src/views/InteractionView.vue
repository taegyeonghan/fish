    ...
    <aside class="uf-sidebar">
      ...
      <nav class="uf-steps-vertical">
        <div
          ...
          class="uf-step-item"
          :class="{
            'uf-step-active': 5 === idx + 1,
            'uf-step-completed': 5 > idx + 1,
            'uf-step-disabled': 5 < idx + 1
          }"
          :data-label="name"
        >
    ...
    <main class="uf-main">
      <div class="uf-subheader">
        <div class="uf-subheader-left">
          ...
          <span class="uf-crumb">Step 5</span>
          <span class="uf-crumb-arrow">▸</span>
          <span class="uf-crumb-current">{{ $tm('main.stepNames')[4] }}</span>
        </div>
